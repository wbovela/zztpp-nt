...
// For reading the world file we need to know
// the size in bytes of each part of the file. Please refer to
// the Board class for more information about the world file.
#define	SIZE_GAMEINFO	286
#define	SIZE_BOARDHEADINFO	1
#define	SIZE_BLOCK	1
#define	SIZE_BOARDINFO	1
#define	SIZE_OBJECT	1
